...
app.get(
  ...
  require("./src/routes/getSingleInventoryRoutes")
);

// get all inventory items
app.get(
  "/api/all/item/inventory",
  require("./src/routes/AllInventoryItemsRoutes")
);

// delete item inventory
app.delete(
  "/api/delete/inventory/:id",
  require("./src/routes/deleteInventoryRoutes")
);

// edit inventory
app.put(
  "/api/update/inventory/:id",
  require("./src/routes/updateInventoryRoutes")
);

// add item inventory
app.post(
  "/api/add/item/inventory",
  require("./src/routes/addItemInventoryRoutes")
);
...
app.delete(
  ...
  require("./src/routes/deleteProductsRoutes")
);
...
app.put(
  ...
  upload.single("image"),
  require("./src/routes/updateProductsRoutes")
);
...
app.post(
  "/api/add/product",
  upload.single("image"),
  require("./src/routes/addProductsRoutes")
);
...
app.get("/api/user/logout",require("./src/routes/userLogoutRoutes"))
